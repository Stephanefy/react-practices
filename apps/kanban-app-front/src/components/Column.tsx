...
const Column = forwardRef<HTMLElement, ColumnProps>((props: ColumnProps, ref) => {
  ...
  return (
    ...
    <h3 className="text-base text-primary-gray flex justify-between">
      <div>
        <span
      ...
      <div>
        <span role="button" className="cursor-pointer" onClick={() => deleteColumnFromCurrentBoard(props.column.id)}>
          <CrossSvg />  
        </span>
      </div>
    </h3>
